...
PUB main
  ...
  ' ####################### DO NOT MODIFY ANYTHING ABOVE THIS LINE #######################
     s2.arc_to (SCALE*0, SCALE*14, SCALE*-7)
     s2.arc_to (SCALE*0, SCALE*0, SCALE*7)
     s2.move_to (SCALE*3, SCALE*0)
     
     S2.move_to (SCALE*3, SCALE*15)
     S2.move_to (SCALE*3, SCALE*6)
     S2.move_to (SCALE*7, SCALE*6)
     s2.move_to (SCALE*7, SCALE*15)
     s2.move_to (SCALE*7, SCALE*0)


     s2.move_to (SCALE*9, SCALE*0)
     s2.move_to (SCALE*9, SCALE*11)
     s2.move_to (SCALE*9, SCALE*15)
     s2.arc_to(SCALE*9, SCALE*11, SCALE*-2)
